...
const ContactSection = () => {
  // ✅ PERF FIX: lazy-load Spline 3D robot only when visible in viewport
...
Sent from your portfolio contact form`;
  ...
  return (
    <section id="contact" className="min-h-screen flex items-center px-4 py-16 sm:py-20 md:py-24 bg-transparent relative overflow-hidden">
      {/* Background Overlay */}
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="text-center mt-16 pt-8 border-t border-gray-700/50">
          <p className="text-white text-sm sm:text-base animate-text-reveal delay-1600">
            @ {new Date().getFullYear()} <span className="font-bold text-red">Chethiya Vishwa.</span> All rights reserved.
          </p>
        </div>
      </div>
    </section>
